...
export default function PrivacyPolicy() {
  return (
    <div className="p-6 font-sans">
      ...
      <p>
        This privacy policy applies to the Where is Kaaba app (hereby referred
        to as &ldquo;Application&ldquo;) for mobile devices that was created by
        DaeWon Kim (hereby referred to as &ldquo;Service Provider&ldquo;) as an
        Ad Supported service. This service is intended for use &ldquo;AS
        IS&ldquo;.
      </p>

      <h2 className="font-bold text-lg mt-6">Information Collection and Use</h2>
      <p>
      ...
      <h2 className="font-bold text-lg mt-6">Third Party Access</h2>
      <p>
      ...
      <h2 className="font-bold text-lg mt-6">Opt-Out Rights</h2>
      <p>
      ...
      <h2 className="font-bold text-lg mt-6">Data Retention Policy</h2>
      <p>
        ...
        <a href="mailto:jisanoai@gmail.com" className="text-blue-500 underline">
          jisanoai@gmail.com
        </a>{" "}
      ...
      <h2 className="font-bold text-lg mt-6">Security</h2>
      <p>
      ...
      <h2 className="font-bold text-lg mt-6">Changes</h2>
      <p>
      ...
      <p>This privacy policy is effective as of 2024-07-12</p>

      <h2 className="font-bold text-lg mt-6">Your Consent</h2>
      <p>
